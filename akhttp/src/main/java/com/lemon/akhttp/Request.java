...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     * throw {@link com.lemon.akhttp.error.AuthFailureError} as authentication may be required to
     ...
     * attempts remaining, this will cause delivery of a {@link com.lemon.akhttp.error.TimeoutError} error.
     */
